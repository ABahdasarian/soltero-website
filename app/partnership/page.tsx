  ...
  return (
    <main className="pt-24">
      <section className="mx-auto max-w-4xl px-6 py-20 md:py-28">
        <FadeIn>
          <div className="text-center">
            ...
            <p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-neutral-600">
              We welcome bridal boutiques and selected retail partners
              who share our appreciation for timeless elegance,
              exceptional craftsmanship and modern bridal design.
            </p>
          </div>
        </FadeIn>
        ...
        {success ? (
          <FadeIn>
            <div className="mt-20 border border-[#ECE6DF] bg-[#F8F6F3] px-8 py-16 text-center md:px-16">
              <span className="text-xs uppercase tracking-[0.4em] text-[#B9935D]">
                Thank You
              </span>

              <h2 className="mt-6 font-heading text-4xl text-[#2A2A2A]">
              ...
              <button
                ...
                className="mt-10 border border-[#B9935D] bg-[#B9935D] px-8 py-4 text-xs uppercase tracking-[0.35em] text-white transition duration-300 hover:bg-[#927A5D]"
              >
            ...
            >
              ...
              <div>
                ...
                <select
                  ...
                  defaultValue=""
                  required
                  className="w-full border border-[#DDD5CD] bg-white px-5 py-4 text-sm text-[#2A2A2A] outline-none transition focus:border-[#B9935D]"
                >
              ...
              <div className="pt-4 text-center">
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full border border-[#B9935D] bg-[#B9935D] px-8 py-5 text-xs uppercase tracking-[0.35em] text-white transition duration-300 hover:bg-[#927A5D] disabled:cursor-not-allowed disabled:opacity-60"
                >
